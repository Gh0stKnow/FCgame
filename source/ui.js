...
if (typeof jQuery !== 'undefined') {
  (function ($) {
    ...
    $('.controller-area').append($(`<a href="${decodeURIComponent('https%3A%2F%2Fimg.xx8g.com%2Ffc%2Fgzherweima.jpg')}" target="_blank"><div class="joy">${decodeURIComponent('%E5%85%AC%E4%BC%97%E5%8F%B7')}<br><b>${decodeURIComponent('%E5%B0%8F%E9%AB%98%E6%95%99%E5%AD%A6%E7%BD%91')}</b></div></a>`));
    var a1 = $(`<a href="${decodeURIComponent('https%3A%2F%2Fwww.xg3q.com%2Fwangzhanyuanma%2F23963.html')}" target="_blank" class="readme">${decodeURIComponent('%E8%8E%B7%E5%8F%96%E6%BA%90%E7%A0%81')}</a>`)
